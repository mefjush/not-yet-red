...
import LightConfig, { DEFAULT_LIGHT_SETTINGS, TEST_LIGHT_SETTINGS } from '../../app/domain/LightConfig'
...
describe('TrafficLight', () => {
  it('calculates next transition when in the middle of first phase', () => {
    let trafficLight = new TrafficLight(new LightConfig(intersectionSettings, lightSettings), false)
